...
for d in daily_transactions:
  daily_transactions_split.append(d.split("-"))
...
for c in colors:
  string = "{} threads of {} color was sold today.".format(color_count(c), c)
  print(string)
